...
// 사용자가 요청 -> 응답(HTML 파일 ) 할꺼면 @Controller
...
public class HttpControllerTest {
	...
	public String lombokTest() {
		//builder() 생성자의 순서를 지키지 않아도 된다. 내가 넣고싶은 값만 넣을 수 있다.
		Member m = Member.builder().username("cho").password("1234").email("rhdqnx@naver.com").build();
	...
	public String getTest(Member m) { // MessageConverter(스프링부트) 
		// 쿼리스트링 방식 : id=1&username=ssar&password=1234&email=ssar@nate.com
